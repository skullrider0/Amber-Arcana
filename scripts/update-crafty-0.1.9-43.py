...
def install(blob, root):
    ...
    with zipfile.ZipFile(io.BytesIO(blob)) as archive:
        ...
        try:
            for entry in members:
                ...
                # Same-directory atomic replacement, preserving the server's ownership.
    ...
    print('Every player should import the matching 0.1.9-43 Client ZIP. Reconnect after restart to refresh JEI.')
