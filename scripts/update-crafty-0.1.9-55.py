...
EXACT_FILES = {
    ...
    'mods/morehitboxes-forge-1.20.1-1.9.2.3.jar',
    'config/modernfix-mixins.properties',
    'kubejs/server_scripts/amber_arcana_spawn_balance.js',
    'kubejs/startup_scripts/amber_arcana_powah_thermo_compat.js',
}
PREFIXES = (
    'config/ftbquests/quests/',
    'config/servercore/',
    'config/mobtimizations/',
    'config/spark/',
    'kubejs/data/',
    'kubejs/assets/',
)
...
def install(blob, root):
    ...
    print('Every player should import the matching 0.1.9-55 Client ZIP before reconnecting.')
